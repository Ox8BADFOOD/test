...
FOUNDATION_EXPORT UIFont * zz_Font(CGFloat size);
FOUNDATION_EXPORT UIFont * zz_MediumFont(CGFloat size);
FOUNDATION_EXPORT UIFont * zz_BoldFont(CGFloat size);
FOUNDATION_EXPORT UIFont * zz_HeavyFont(CGFloat size);
#endif /* ZZFont_h */
